...
class RedactedTest < ActionDispatch::IntegrationTest
  ...
  test "Redacted::ActionView::Helpers are loaded" do
    assert(Redacted::ActionView::Helpers.present?, 'Redacted::ActionView::Helpers are not defined')
  end

  test "method redact_html is defined" do
